...
Jenkinsfile in the root of the project contains Jenkins Pipeline declaration. With this and our [DevOps asset library for 10.x versions](https://github.com/SoftwareAG/sagdevops-ci-assets) you will be able to set up you CI in a matter of minutes.
